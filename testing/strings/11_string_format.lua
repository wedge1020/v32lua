...
function main()
    ...
    print(  0,   0, "--- string.format Test ---")
    print(  0,  20, "Test 00 - %.2f: "             .. string_result00)
    print(  0,  40, "Test 01 - %.0f: "             .. string_result01)
    print(  0,  60, "Test 02 - %.4f: "             .. string_result02)
    print(  0,  80, "Test 03 - %f default: "       .. string_result03)
    print(  0, 100, "Test 04 - %d: "               .. string_result04)
    print(  0, 120, "Test 05 - %d neg: "           .. string_result05)
    print(  0, 140, "Test 06 - %d trunc: "         .. string_result06)
    print(  0, 160, "Test 07 - %i: "               .. string_result07)
    print(  0, 180, "Test 08 - %u: "               .. string_result08)
    print(  0, 200, "Test 09 - %s: "               .. string_result09)
    print(  0, 220, "Test 10 - %c: "               .. string_result10)
    print(  0, 240, "Test 11 - %q: "               .. string_result11)
    print(  0, 260, "Test 12 - %e (fixed-pt): "    .. string_result12)
    print(  0, 280, "Test 13 - %g (fixed-pt): "    .. string_result13)
    print(320,  20, "Test 14 - Multi: "            .. string_result14)
    print(320,  40, "Test 15 - Mixed text: "       .. string_result15)
    print(320,  60, "Test 16 - No specs: "         .. string_result16)
    print(320,  80, "Test 17 - %%: "               .. string_result17)
    ...
    print(320, 300, "Test 28 - %08x padded: "      .. string_result28)
end
